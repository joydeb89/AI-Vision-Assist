...
st.markdown('<div class="main-title">👁️ AI Vision Assist 👁️</div>', unsafe_allow_html=True)
...
st.markdown(
    ...
    <footer style="text-align:center;">
        <p>Powered by <strong>Google Gemini API</strong> | ©️ Joydeb | Built with ❤️ using Streamlit</p>
    </footer>
    """,
    unsafe_allow_html=True,
)
